...
Name:           ros-jazzy-leo-example-follow-aruco-marker
Version:        1.1.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS leo_example_follow_aruco_marker package

License:        MIT
URL:            https://index.ros.org/p/leo_example_follow_aruco_marker/#jazzy
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-jazzy-aruco-opencv
